...
\frame{\frametitle{IDE?}
    ...
    \begin{enumerate}
        ...
        \item<1-> VSCode, a very popular text editor in electron on the rise. Great for industry practice
        \item<1-> Pycharm, I don't have much experience with pycharm but I've heard great things if you want to give it a shot
        \item<1-> Neovim/Vim, I personally use vim/neovim because I hate myself
    \end{enumerate}
